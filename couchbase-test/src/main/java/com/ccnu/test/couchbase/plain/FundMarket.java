...
/**
 * Created by gongyb08837 on 2015/11/29.
 */
public class FundMarket implements Serializable{
     ...
     * 最大申购金额
     */
    private double max_purchase_amount = -1;//默认-1
    /**
     * 最小申购金额
     */
    private double min_purchase_amount = -1;//默认-1
    /**
     * 最大定投金额
     */
    ...
    public void setMin_purchase_amount(double min_purchase_amount) {
        this.min_purchase_amount = min_purchase_amount;
    }
